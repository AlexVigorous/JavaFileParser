...
public class PrinterService {
    ...
    public void printDirectoryReport(DirectoryReport directoryReport) {
        System.out.println(ParserUtils.getTabsString(directoryReport.getLevel()) + directoryReport.getName() +
            " : " + directoryReport.getTotalLinesCount());
        directoryReport.getFiles().forEach(fileReport -> printFileReport(fileReport, directoryReport.getLevel() + 1));
